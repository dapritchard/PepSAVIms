...
The \prisms/ \R/ package provides a collection of software tools used to
...
out some of the noice detected in the dataset.  By filtering the candidate set
...
compounds is performed.  This step is performed by the \rankEN/ function, and
...
functions by walking through the prototypical PRISMS pipeline.  A flowchart for
this prototypical PRISMS pipeline is shown below.
...
Gram-negative bacterium E. coli as an illustrative example, and create an object
