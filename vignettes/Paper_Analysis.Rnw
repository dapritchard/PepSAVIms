...
From the output below we see that for the \textit{E. coli}, \textit{E. faecium},
and breast cancer data sets, at least one charge state corresponding to cyO2 is
identified in the first 20 candidate compounds.  For the \textit{A. baumannii},
...
sets cyO2 is identified in the first 50 compounds.
...
top-20 likely contributor to bioactivity against three of the eight pathogens,
