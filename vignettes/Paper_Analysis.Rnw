...
The compound cyO2 is known to have a deleterious effect in each of the
bioactivity peptide libraries.  Here we wish to use the cyO2 compound to
assess how well the \prisms/ pipeline is able to identify this known compound.
...
From the output we see that for ef, pc, and bc, one of the versions of cyO2 is
...
peptide libraries cyO2 is ranked within the top 100 compounds.  Of course this
out of 38,000 starting compounds.
