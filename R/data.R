...
#'     and 44 columns (with the exception of \code{\emph{F. graminearum}} which
#'     has 2 rows).  The rows in each \code{data.frame} correspond to
#'     replications of the data collection process, while the columns correspond
#'     to relative growth inhibition bioactivity levels when subject to peptide
#'     libraries across fractions 1-43 and fraction 47.
#'
#' \describe{
#'
#'     \item{ec}{\emph{E. coli}}
